...
- Building packages for your router architecture
- Installation and configuration
- LuCI web interface and UCI command-line setup
...
**📖 [Complete MikroTik Documentation](docs/MIKROTIK.md)**

The documentation covers:
- Container package installation
- Network configuration with veth interfaces
- Port forwarding setup
- Container deployment and management
- Troubleshooting

**Key points:**
- No external disk required
- Runs on internal storage
- Works on CHR, CCR, RB5009, and other RouterOS 7.4+ devices
